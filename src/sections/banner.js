...
export default function Banner() {
  ...
  sx={{
    ...
    fontWeight: 'bold',
    padding: '15px 30px',
    backgroundColor: '#b7934c', // Couleur marron pour le fond
    '&:hover': {
      backgroundColor: '#996600', // Garde la couleur marron au survol
      boxShadow: 'rgba(153, 102, 0, 0.57) 0px 9px 20px -5px', // Box-shadow marron
    },
  }}
>
  Contactez-nous
