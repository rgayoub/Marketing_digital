  ...
  monthly: [
    {
      ...
      priceWithUnit: '9€',
      points: [
        { id: 1, icon: <IoIosCheckmarkCircle />, text: 'Design', isAvailable: true },
    ...
    },
    {
      ...
      points: [
        { id: 1, icon: <IoIosCheckmarkCircle />, text: 'Design', isAvailable: true },
        { id: 2, icon: <IoIosCheckmarkCircle />, text: 'Création de contenu', isAvailable: true },
        { id: 3, icon: <IoIosCloseCircle />, text: 'Community Manager', isAvailable: false },
        { id: 4, icon: <IoIosCloseCircle />, text: 'Production audiovisuelle', isAvailable: false },
      ],
    },
    {
      ...
      points: [
        { id: 1, icon: <IoIosCheckmarkCircle />, text: 'Design', isAvailable: true },
        { id: 2, icon: <IoIosCheckmarkCircle />, text: 'Création de contenu', isAvailable: true },
        { id: 3, icon: <IoIosCheckmarkCircle />, text: 'Community Manager', isAvailable: true },
        { id: 4, icon: <IoIosCheckmarkCircle />, text: 'Production audiovisuelle', isAvailable: true },
      ],
    },
  ],
  annual: [
